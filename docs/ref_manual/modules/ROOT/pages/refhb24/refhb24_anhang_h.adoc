[unnumbered]
= Anhang H (Standard-Erweiterungsvorschlag) – Einheiten-Definitionen
...
[unnumbered]
== Das Typen-Modell
Das folgende Typen-Modell fasst die gebräuchlichsten Einheiten zusammen. Es erweitert die durch INTERLIS direkt definierten Einheiten (vgl. xref:refhb24/refhb24_anhang_a.adoc[Anhang A - Das interne INTERLIS-Datenmodell]).
...
[unnumbered]
== Beispiele
Vgl. Kapitel xref:refhb24/refhb24_root.adoc#_basiseinheiten[Kapitel Basiseinheiten im INTERLIS 2-Referenzhandbuch]
