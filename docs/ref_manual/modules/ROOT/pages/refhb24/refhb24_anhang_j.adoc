...
[#figj3]
.Umrechnung vom kartesischen _L* a* b*_-Raum in die polare Form _L* C*~ab~ h*~ab~_ (nach [Sangwine/Horne, 1998]).
...
+
_Das Referenzhandbuch für PostScript unter anderem auch mit Hinweisen auf die Behandlung von Farben und verschiedene Umrechnungsmethoden, die in PostScript verfügbar sind. Beispiel 4.11 auf Seite 191 definiert den _L* a* b*_-Farbraum in PostScript._

* [Adobe, 1992] Adobe Developers Association: *TIFF Revision 6.0*.  
+
https://partners.adobe.com/public/developer/en/tiff/TIFF6.pdf  
+
_Kapitel 23 definiert eine Variante des TIFF-Formats für Bilder im _L* a* b*_-Farbraum und nennt eine Anzahl von Vorteilen gegenüber RGB. Ausserdem wird eine schnelle Methode zur Umrechnung von _L* a* b*_ zu RGB skizziert._
