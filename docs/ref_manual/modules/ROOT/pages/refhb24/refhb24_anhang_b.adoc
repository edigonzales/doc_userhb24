[unnumbered]
= Anhang B (normativ) – Das XML-Schema für das Modell INTERLIS

Das folgende XML-Schema definiert Basistypen für die Schemagenerierungsregeln gemäss xref:refhb24/refhb24_anhang_a#_herleitung_des_xml_schema_aus_dem_datenmodell[Herleitung des XML-Schema aus dem Datenmodell] und das Modell INTERLIS gemäss xref:refhb24/refhb24_anhang_a[Anhang A].
