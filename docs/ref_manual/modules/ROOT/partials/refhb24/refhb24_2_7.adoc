...
[#fig6]
.Abbildung {chap}-{counter:figctr}: Die verschiedenen Einsatzgebiete von INTERLIS (ein doppelter Pfeil bedeutet inkrementelle Nachlieferung).
image::refhb24/refhb24_fig6.png[]

Betrachtet man ein Beispiel des Zusammenwirkens verschiedener Beteiligter, ist es offensichtlich, dass je nach Einsatzgebiet und Rolle eines Beteiligten unterschiedliche Werkzeugfähigkeiten oder Dienste von INTERLIS 2 gefragt sind (siehe <<fig6,Abbildung {chap}-6>>). Ein einzelner Beteiligter kann in einer Anwendung (d.h. INTERLIS-Modell) mit verschiedenen Themen (TOPICS) mehrere Rollen einnehmen:
