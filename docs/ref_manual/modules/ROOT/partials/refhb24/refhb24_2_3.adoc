...
Beispielsweise könnte ein Modell der Amtlichen Vermessung eines Landes unter anderem die Themen «Adressen» und «Gebäude» umfassen (siehe <<fig3,Abbildung {chap}-3>>). Diese Konzepte sind voneinander unabhängig; der Bezug wird algorithmisch über Koordinaten hergestellt. Personen weisen Adressen auf, so dass das Personen-Modell dieses Landes auf dem Landesmodell der Amtlichen Vermessung aufbaut, wobei das Thema «Personen» vom Thema «Adressen» des Vermessungsmodells abhängt.

[#fig3]
.Abbildung {chap}-{counter:figctr}: Vererbungs-Hierarchie von Adresse, Person und Gebäude.
image::refhb24/refhb24_fig3.png[]
